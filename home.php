                        ...
                        <div class="guides-grid">
                            ...
                            <div class="guides-block">
                                ...
                                <div class="guides-list">
                                    ...
                                    <a href="<?php echo bloginfo('url'); ?>/category/guides/talents/" class="guides-link">
                                    ...
                                    <a href="<?php echo bloginfo('url'); ?>/category/guides/chakras/" class="guides-link">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/chakras-icon.png"
                                             alt="Чакры"
                                             class="guides-link__img">
                                        <span class="guides-link__text">Чакры</span>
                                    </a>
                                    <a href="<?php echo bloginfo('url'); ?>/category/guides/elements/" class="guides-link">
                                    ...
                                    <a href="<?php echo bloginfo('url'); ?>/category/guides/paragons/" class="guides-link">
                                    ...
                                    <a href="<?php echo bloginfo('url'); ?>/category/guides/miscellaneous/" class="guides-link">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="gallery-wrapper">
                            <div class="heading-container">
                                <a href="<?php echo bloginfo('url'); ?>/gallery" class="title-block">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="faq-text">Записи отсутствуют</p>
                    </div>
                </div>
            </div>
        </section>
